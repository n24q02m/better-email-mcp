...
describe('CallToolRequestSchema handler coverage', () => {
  ...
  it('should return error when no arguments are provided (lines 280-286)', async () => {
  ...
  it('should provide suggestion for unknown tool (lines 292-294)', async () => {
    const result = await callToolHandler({
      params: {
  ...
  it('should successfully call a tool and wrap the result (lines 301-310)', async () => {
  ...
  it('should handle tool handler throwing an error (lines 312-324)', async () => {
