/**
 * Templates for the email credential form.
 */
...
export function renderFormScript(submitUrlJson: string): string {
  return `
        (function () {
...
export function renderFormHtml(options: {
  displayName: string
  server: string
  description: string
  css: string
    ...
    <main class="container">
        <div class="card">
            <div class="server-header">
                <h1 class="server-name">${options.displayName}</h1>
                <div class="server-id">${options.server}</div>
                <p class="server-description">${options.description}</p>
            </div>
