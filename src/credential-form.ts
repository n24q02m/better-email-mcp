            ...
            function renderDomainSpecificFields(extraContainer, idx, domain, state) {
                ...
                if (Object.prototype.hasOwnProperty.call(APP_PASSWORD_DOMAINS, domain)) {
                    ...
                    var pw = createFieldGroup({
                        ...
                        key: "password",
                        label: info.label,
                        type: "password", required: true, helpText: info.helpText,
                ...
                var imap = createFieldGroup({
                    ...
                    label: "IMAP Host",
                    type: "text",
                    placeholder: "imap.example.com", helpText: "Optional. Leave empty for auto-detection. Accepts localhost or a proxy host."
                });
                ...
                var imapPort = createFieldGroup({
                    ...
                    label: "IMAP Port",
                    type: "text",
                    placeholder: "993", helpText: "Optional. Default 993. Set a custom port for a local IMAP proxy."
                });
