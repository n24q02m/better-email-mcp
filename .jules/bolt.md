...
## 2024-08-20 - [Avoid V8 object allocation with Object.assign in hot paths]
**Learning:** In hot loops, `Object.assign(obj, { [key]: value })` allocates a new temporary object for every iteration, which can cause significant garbage collection overhead and slower execution times compared to direct property assignment.
**Action:** When mutating an object in a hot path, prefer direct property assignment like `obj[key] = value` over `Object.assign` to prevent unnecessary allocations.
